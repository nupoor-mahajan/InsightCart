...
st.title("Hyperparameter Tuned Random Forest Predictor")


@st.cache_resource
def load_model_files():
    model = pickle.load(open("models/hypertuned_random_forest.pkl", "rb"))
...
if st.button("Analyze with Tuned Random Forest", type="primary"):
    ...
    try:
        ...
        st.error("Tuned Random Forest failed.")
        st.code(str(e))